...
args=(
    ...
    "algo.eval_freq=10_000"
    "algo.log_freq=50_000"
    "algo.save_freq=250_000"
    "algo.save_backup_ckpts=True"
    "eval_env.make_env=True"
    "env.make_env=True"
    "env.num_envs=32"  # Something reasonable that won't OOM workstation GPU
    "env.env_kwargs.require_build_configs_repeated_equally_across_envs=False"
    "eval_env.num_envs=32"
    "eval_env.env_kwargs.require_build_configs_repeated_equally_across_envs=False"
